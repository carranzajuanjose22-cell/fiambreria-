import { ShoppingCart, Package, Wallet, History, Settings } from 'lucide-react';
  ...
  return (
    <div className="w-64 h-screen bg-[#0f0f0f] border-r-2 border-[#2a2a2a] flex flex-col">
      ...
      <div className="p-4 border-t-2 border-[#2a2a2a]">
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-white300 hover:bg-[#1a1a1a] hover:text-white transition-colors">
